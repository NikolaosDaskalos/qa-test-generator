...
Repository Documents and proposed Test File contents appear in a prompt. Per-adapter
...
def format_repository_documents(documents: list) -> str:
    """Render Repository Documents as ``[Source: <path>]``-labeled, ``---``-separated blocks."""
