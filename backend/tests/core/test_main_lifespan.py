...
def test_lifespan_initializes_and_closes_weaviate_and_checkpointer(monkeypatch) -> None:
    ...
    monkeypatch.setattr(main, "initialize_weaviate", lambda: events.append("weaviate_initialized"))
    monkeypatch.setattr(main, "close_weaviate", lambda: events.append("weaviate_closed"))
...
def test_lifespan_propagates_startup_failure(monkeypatch) -> None:
    ...
    monkeypatch.setattr(main, "initialize_weaviate", fail_initialization)
