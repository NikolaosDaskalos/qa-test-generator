...
- [ ] The reranker receives only the repository-scoped, above-threshold candidate Code Chunks produced by issue 04.
...
- [ ] Empty hybrid results, all-below-threshold results, empty reranker results, and missing parent records produce an empty Repository Evidence result without creating a tenant or fabricating context.
