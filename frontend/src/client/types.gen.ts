 ...
 */
export type AiCostRollupPublic = {
    cost?: number;
    input_tokens?: number;
...
export type CostsReadSessionCostData = {
    repositorySessionId: string;
};

export type CostsReadSessionCostResponse = (AiCostRollupPublic);

export type CostsReadRepositoryCostData = {
    repositoryId: string;
};

export type CostsReadRepositoryCostResponse = (AiCostRollupPublic);

export type CostsReadMyCostResponse = (AiCostRollupPublic);

export type CostsReadAllUsersCostResponse = (AiCostRollupPublic);
...
export type SessionsReadTurnCostData = {
    repositorySessionId: string;
    sessionHistoryId: string;
};

export type SessionsReadTurnCostResponse = (TurnCostPublic);
...
export type SessionsReadRunCostData = {
    codingRunId: string;
    repositorySessionId: string;
};

export type SessionsReadRunCostResponse = (TurnCostPublic);
