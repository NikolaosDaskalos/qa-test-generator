...
export const AiCostRollupPublicSchema = {
    properties: {
        cost: {
            type: 'number',
            title: 'Cost',
    ...
    type: 'object',
    title: 'AiCostRollupPublic',
    description: `A summed AI Cost total across one attribution dimension — session, Repository, or user.
...
export const HumanDecisionRequestSchema = {
    properties: {
        ...
        verdict: {
            '$ref': '#/components/schemas/OwnerVerdict'
        },
        feedback: {
            type: 'string',
            maxLength: 4000,
    ...
    type: 'object',
    required: ['coding_run_id', 'verdict'],
...
export const OwnerVerdictSchema = {
    type: 'string',
    enum: ['approve', 'reject', 'edit'],
    title: 'OwnerVerdict',
    description: `The owner's human-in-the-loop verdict on an escalated Test Patch.
...
export const TurnCostPublicSchema = {
    properties: {
        session_history_id: {
            anyOf: [
                {
    ...
    type: 'object',
    title: 'TurnCostPublic',
    description: `The AI Cost of a single turn, summed from its Usage Records (ADR-0014).
